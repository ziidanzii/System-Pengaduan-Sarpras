...
<head>
    ...
    <style>
        ...
        /* Shared Status Badges and Buttons */
...
<body>
    ...
    <!-- Petugas -->
    <li class="nav-item">
        <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('admin.petugas.*') ? 'active' : '' }}"
    ...
    <!-- Pengaduan -->
    <li class="nav-item">
        <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('admin.pengaduan.*') ? 'active' : '' }}"
    ...
    <!-- Item -->
    <li class="nav-item">
        <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('admin.items.*') ? 'active' : '' }}"
    ...
    <!-- Lokasi -->
    <li class="nav-item">
        <a class="nav-link d-flex align-items-center gap-2 {{ request()->routeIs('admin.lokasi.*') ? 'active' : '' }}"
